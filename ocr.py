...
def extract_info(text):
    ...
    # 提取付款时间
    payment_time_match = re.search(r'支 付 时 间 (.*?)\n', text)
    payment_time = payment_time_match.group(1) if payment_time_match else None
